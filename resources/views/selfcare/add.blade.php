...
@section('container')
    <div style="height: 100vh; width: 80vw;display: flex;flex-direction: column; justify-content: start; overflow: auto; white-space: nowrap; margin-top: 10vh;">
        <div style="width: 77vw; height: 7.5vh; padding: 15px 10px 0 15px">
            ...
            <form action="/selfcare/create" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <button type="submit" class="btn btn-primary" style="margin-top: 15px; margin-bottom: 20px">Tambah Selfcare</button>
            </form>
        </div>
    </div>
@endsection
